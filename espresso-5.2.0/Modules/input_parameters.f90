...
!
        ...
        CHARACTER(len=256) :: prefix = 'prefix'
          ...
          ! ... prefix to read out the charge density if we enter flipper  LEONID
        ...
        NAMELIST / control / title, calculation, verbosity, restart_mode, &
          ...
          prefix_flipper_charge, lflipper                                 ! LEONID
...
!
       ...
       INTEGER :: iesr = 1
        ...
        NAMELIST / ions / ion_dynamics, iesr, ion_radius, ion_damping,         &
                          ...
                          nstep_thermo                                         ! LEONID: nstep for thermostat
